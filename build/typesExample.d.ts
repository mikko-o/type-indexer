...
import { AvailFilterKeys, GetFilter } from ".";
import { TypedEvent, TypedEventFilter } from "./types/typechain/common";
...
export type Filters<C extends BaseContract> = {
    [K in keyof GetMultiEventIndexerFilterObj<C>]+?: GetMultiEventIndexerFilterObj<C>[K];
};
...
export type getListenerFiltersType<C extends BaseContract> = {
    [K in keyof getEventListenerFilterObj<C>]+?: getEventListenerFilterObj<C>[K];
};
export {};
