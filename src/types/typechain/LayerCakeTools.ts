...
export declare namespace LayerCakeExecutionProof {
  ...
  export type ExecutionProofStruct = {
  ...
  export type ExecutionProofStructOutput = [
...
export interface LayerCakeToolsInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getExecutionId",
    values: [BytesLike, LayerCakeExecutionProof.OperationsStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "getInvalidExecutionProofId",
    values: [LayerCakeExecutionProof.ExecutionProofStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "getPathwayId",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "recoverSigner",
    values: [BytesLike, LayerCakeExecutionProof.ExecutionProofStruct]
  ): string;
...
export namespace BandwidthChangedEvent {
...
export namespace OperationsExecutedEvent {
  export type InputTuple = [
...
export namespace OperationsStoredEvent {
  export type InputTuple = [
    executionId: BytesLike,
    operations: LayerCakeExecutionProof.OperationsStruct
  ];
...
export interface LayerCakeTools extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "getExecutionId"
  ): TypedContractMethod<
    [
      pathwayId: BytesLike,
      operations: LayerCakeExecutionProof.OperationsStruct
  ...
  >;
  getFunction(
    nameOrSignature: "getInvalidExecutionProofId"
  ): TypedContractMethod<
    [invalidExecutionProof: LayerCakeExecutionProof.ExecutionProofStruct],
    [string],
    "view"
  ...
  getEvent(
    key: "BandwidthChanged"
  ): TypedContractEvent<
    BandwidthChangedEvent.InputTuple,
    BandwidthChangedEvent.OutputTuple,
    BandwidthChangedEvent.OutputObject
  >;
  getEvent(
    key: "OperationsExecuted"
  ): TypedContractEvent<
    OperationsExecutedEvent.InputTuple,
    OperationsExecutedEvent.OutputTuple,
    OperationsExecutedEvent.OutputObject
  >;
  getEvent(
    key: "OperationsStored"
  ): TypedContractEvent<
    OperationsStoredEvent.InputTuple,
    OperationsStoredEvent.OutputTuple,
    OperationsStoredEvent.OutputObject
  >;

  filters: {
    "BandwidthChanged(address,bool,uint256)": TypedContractEvent<
      BandwidthChangedEvent.InputTuple,
      BandwidthChangedEvent.OutputTuple,
      BandwidthChangedEvent.OutputObject
    >;
    BandwidthChanged: TypedContractEvent<
      BandwidthChangedEvent.InputTuple,
      BandwidthChangedEvent.OutputTuple,
      BandwidthChangedEvent.OutputObject
    >;

    "OperationsExecuted(bytes32,address,tuple,bool)": TypedContractEvent<
      OperationsExecutedEvent.InputTuple,
      OperationsExecutedEvent.OutputTuple,
      OperationsExecutedEvent.OutputObject
    >;
    OperationsExecuted: TypedContractEvent<
      OperationsExecutedEvent.InputTuple,
      OperationsExecutedEvent.OutputTuple,
      OperationsExecutedEvent.OutputObject
    >;

    "OperationsStored(bytes32,tuple)": TypedContractEvent<
      OperationsStoredEvent.InputTuple,
      OperationsStoredEvent.OutputTuple,
      OperationsStoredEvent.OutputObject
    >;
    OperationsStored: TypedContractEvent<
      OperationsStoredEvent.InputTuple,
      OperationsStoredEvent.OutputTuple,
      OperationsStoredEvent.OutputObject
    >;
